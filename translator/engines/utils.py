...
from translator.config.translate_engine_model import TranslateEngineSettingError
...
def _create_translator_instance(
    ...
    for metadata in TRANSLATION_ENGINE_METADATA:
        if isinstance(translator_config, metadata.setting_model_type):
            ...
            model_name = f"translator.engines.translator_impl.{translate_engine_type.lower()}"
