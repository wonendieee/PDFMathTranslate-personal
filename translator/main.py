...
def find_all_files_in_directory(directory_path):
    """
    Recursively search all supported document files (PDF, DOCX, DOC, XLSX, XLS) in the given directory and return their paths as a list.
...
async def main() -> int:
    ...
    if settings.basic.gui:
        from translator.gui import setup_gui
