...
from translator.format import validate_file_format
...
# discriminator
#
# If you want to use other fields, please go to `translator/config/cli_env_model.py`
    ...
    def validate_settings(self) -> None:
        ...
        for file in self.basic.input_files:
            ...
            try:
                ...
                raise ValueError(f"Invalid file format for {file}: {e}") from e
