...
from translator.config.translate_engine_model import _DEFAULT_TRANSLATION_ENGINE
...
# If you want to use more field parameters in `translator/config/model.py`
