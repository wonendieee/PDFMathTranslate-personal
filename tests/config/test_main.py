...
class TestConfigManager:
    ...
    def temp_config_dir(self, tmp_path: Path) -> Path:
        ...
        config_dir = tmp_path / ".config" / "translator"
    ...
    def test_update_version_default_config(self, temp_config_dir: Path):
        ...
        with (
            ...
            patch("translator.config.main.VERSION_DEFAULT_CONFIG_FILE", version_file),
        ):
    ...
    def test_config_file_priority(
        ...
        with patch("translator.const.DEFAULT_CONFIG_FILE", default_config):
    ...
    def test_ensure_config_dir(self, temp_config_dir: Path):
        ...
        with patch("translator.config.main.DEFAULT_CONFIG_DIR", test_dir):
